...
export const RANKINGS = [
  ...
  },
  {
    ...
    lede: "US states ranked by retail gasoline price — shown per gallon and per liter, from the EIA's weekly survey.",
  ...
  // --- Fuel rankings (EC Weekly Oil Bulletin for the EU + EIA for the US) ---
  {
    ...
    lede: "European countries ranked from cheapest to most expensive petrol (Euro-95) at the pump — in US dollars per liter, all taxes included, from the EC Weekly Oil Bulletin.",
  ...
  },
  {
    ...
    lede: "European countries ranked from most to least expensive petrol (Euro-95) at the pump — in US dollars per liter, all taxes included, from the EC Weekly Oil Bulletin.",
  ...
  },
  {
    ...
    lede: "European countries ranked from cheapest to most expensive automotive diesel at the pump — in US dollars per liter, all taxes included, from the EC Weekly Oil Bulletin.",
  ...
  },
  {
    ...
    lede: "European countries ranked from most to least expensive automotive diesel at the pump — in US dollars per liter, all taxes included, from the EC Weekly Oil Bulletin.",
  ...
  },
  {
    ...
    lede: "Pump prices for petrol (Euro-95 / regular gasoline) ranked across every country Voltlas tracks — in US dollars per liter, all taxes included, from free official sources.",
  ...
  },
  {
    ...
    lede: "Pump prices for automotive diesel ranked across every country Voltlas tracks — in US dollars per liter, all taxes included, from free official sources.",
